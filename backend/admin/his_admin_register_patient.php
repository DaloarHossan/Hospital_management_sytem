                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-group">
                                                <label for="inputAppointment" class="col-form-label">Appointment Date</label>
                                                <input type="date" class="form-control" name="pat_app" id="inputAppointment" placeholder="DD/MM/YYYY">
                                            </div>
